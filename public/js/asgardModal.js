...
class AsgardModal{
     ...
     * 
     * @returns {AsgardModal} este mismo objeto
     * @author Santiago Muñoz
     * @since v 1.0
     */
    sinPie(){
     ...
     * es el metodo empleado por defecto por esta clase en el metodo @see {AsgardModal#mostrarModal}.
     * 
     * @returns {AsgardModal} este mismo objeto
     * @author Santiago Muñoz
     * @since v 1.0
     ...
     * 
     * @see {AsgardModal#mediano}
     * @see {AsgardModal#grande}
     * @see {AsgardModal#extraGrande}
     * 
     * @returns {AsgardModal} este mismo objeto
     * @author Santiago Muñoz
     * @since v 1.0
   ...
   /**
     ...
     * 
     * @see {AsgardModal#construirTitulo}
     * @see {AsgardModal#construirCuerpo}
     * @see {AsgardModal#construirPie}
     * @see {AsgardModal#construirContenedorPrincipal}
     * 
     ...
     * metodo @see {AsgardModal#cargando}
     * 
     * @param {Object:requerido} contenedor 
     * @author Santiago Muñoz
     * @since v 1.0

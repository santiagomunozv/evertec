            ...
            <div class="card-body p-0">
                ...
                <div class="col-lg-6">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="user">
                        ...
                        <input autocomplete="off" class="form-control form-control-user {{ $errors->has('login') ? 'is-invalid' : ''}}" type="text" name="login" value="{{ old('login') }}" placeholder="Ingrese su usuario" id="exampleInputEmail">
                        </div>  
                        <div class="form-group">
                            <input  id="exampleInputPassword" class="form-control form-control-user {{ $errors->has('password') ? 'is-invalid' : ''}}" type="password" name="password" placeholder="Ingrese su contraseña">
                        </div>
